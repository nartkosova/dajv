...
const About = () => {
  const { t: tAboutUsOurStory1 } = useTranslation("about-us-ourstory1");
  const { t: tAboutUsOurStory2 } = useTranslation("about-us-ourstory2");
  const { t: tAboutUsHero } = useTranslation("about-us-hero");
  return (
    <Box>
      <Box
        sx={{
      ...
      >
        ...
        >
          ...
          <p className="text-lg max-w-4xl mb-8 px-4">
            {tAboutUsHero("hero-text")}
          </p>
        </Box>
      </Box>

      <OurStory
        our={tAboutUsOurStory1("small_title")}
        title={tAboutUsOurStory1("title")}
        content={tAboutUsOurStory1("content")}
        showReadMore={false}
      ...
      <OurStory
        our={tAboutUsOurStory2("small_title")}
        title={tAboutUsOurStory2("title")}
        content={tAboutUsOurStory2("content")}
        showReadMore={false}
        image="https://s3-alpha-sig.figma.com/img/2e0e/fafd/58d36059688776d4ba895dbd2789ce57?Expires=1734912000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=bbYxFxmjWdQa6nfWl6B-svty16pv6I40ldGG-PYcr-fiKpWQZprxrJJc9VI2y9vEWe8FlkP8zdy7UkbUj9bLO9~kNJQbp1M1NBzy4fnQcHD1~Vrf7HWsa0jowmRejBQNsz77nhEwkgdxH8rTBugxA20xb-VB2w0M1qnjoSn3ISIJsRh1dEjm0cPZGLFCZtouBrE2CVyVK-ISRTrerE74Jax7KrBStLxAoj~GqUxKmnlGcfAS9t0cXk7Kf4YWdC~hj7XjCFj2sfYhN-TdOJ3V-gSMEZ1Y10UvwFM7EJk-qLyouo0idlNRMgq-FdTMZpPyCJ4KvSro-RcYoe5VZ~wJ4A__"
      />
      ...
      >
        ...
        >
          ...
          >
            Werden Sie Teil unseres Netzwerks und gestalten Sie die Zukunft der
            albanisch-deutschen juristischen Zusammenarbeit mit!
          </Typography>
          <Button
            variant="contained"
            sx={{
